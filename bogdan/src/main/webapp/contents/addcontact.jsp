...
<div class="container">
    <form method="POST" action="contacts" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <label class="control-label" for="firstName">Имя</label><i class="bar"></i>
        </div>
        <div class="form-group">
            <input type="text" name="lastName" id="lastName" required>
            <label class="control-label" for="lastName">Фамилия</label><i class="bar"></i>
        </div>
        <div class="form-group">
        ...
        <div class="form-group gend file_upload">
            ...
            <input id="upload_visible" onclick="document.getElementById('upload_hidden').click();" style="height: 0;" type="text">
        ...
        <div class="button-container">
            <button class="button" type="submit"><span>Сохранить</span></button>
        </div>
        ...
        <div class="modal-body">
            <div class="container" style="padding: 0 3rem;margin: 3rem 0 0 0;">
                <div class="form-group">
                    ...
                    <div class="form-group gend file_upload">
                        <button id="attachedFileBtn" type="button" onclick="document.getElementById('file_upload_hidden').click();" class="button" style="Margin: 0;"><span>Обзор</span></button>
                        <div id="attachedFileName">Файл не выбран</div>
                        <input name="file" id="file_upload_hidden" accept="image/jpeg,image/gif,text/*" style="position: absolute; display: block; overflow: hidden;
				width: 0; height: 0; border: 0; padding: 0;" onchange="document.getElementById('file_upload_visible').value = this.value;
				document.getElementById('attachedFileName').innerHTML = this.value.slice(12);" type="file">
                        <input id="file_upload_visible" onclick="document.getElementById('file_upload_hidden').click();" style="height: 0;" type="text">
                        <label class="control-label" for="attachedFileBtn">Файл</label><i class="bar"></i>
                    </div>
                    <div class="button-container">
...
<div id="myModal" class="modal">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/modalSubmit.js"></script>
</div>
